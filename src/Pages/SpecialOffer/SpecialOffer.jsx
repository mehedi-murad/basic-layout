...
import offerImg from "../../assets/Banner/offer.jpg"
import background from "../../assets/Banner/winter.png"
...
const SpecialOffer = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${background})` }}>
            ...
            <div>
                <h2 className="text-5xl font-bold text-center">Winter Offer!</h2>
            </div>
            <div className="flex flex-col md:flex-row gap-6 justify-between items-center mt-20">
                <div data-aos="fade-right" className="md:w-[700px] space-y-3 p-4">
                    <h2 className="text-3xl font-bold">Special offers for <br /><span className="text-[#6A027B] text-5xl">Kids!</span></h2>
